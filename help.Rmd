...
Plots a partner's value at time $t$ against itself at a previous occasion ($t - 1$).

* **Spillover state-space**:
Plots a partner's value at time $t$ against the other partner's value at a previous occasion ($t - 1$).
